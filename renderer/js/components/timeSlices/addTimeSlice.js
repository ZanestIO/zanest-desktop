    ...
    methods: {
        ...
        processStartYear() {
            ...
            if (isEmpty(input)) {
                ...
                if (!this.name.value)
                    this.name.value = this.suggestTimeSliceName(this.startDate.month.value, this.startDate.year.value)
            }
        },

        suggestTimeSliceName(month, year, finishYear) {
        ...
        processFinishYear() {
            ...
            if (isEmpty(input)) {
                ...
                this.name.value = this.suggestTimeSliceName(this.startDate.month.value, this.startDate.year.value, this.finishDate.year.value)
            }
        },
          ...
          <div class="section-content">
            ...
            <div class="p-2 pt-2 flex">
              <a href="#"
                 ...
                 v-on:click="addTimeSliceInfo">ایجاد ترم</a>
              <a href="#"
                 ...
                 v-on:click="$emit('cancel-add-timeSlice')">انصراف</a>
            </div>
          </div>
          </div>
