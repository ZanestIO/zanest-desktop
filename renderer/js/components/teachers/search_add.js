...
module.exports = {
    ...
    inject: ['addSeen'],
    emits: ['open-search-result', 'adding-teacher'],
    components: {
        overlay
    },
    methods: {
        ...
        search() {
            ...
            ipcRenderer.send('search', {type: 'teacher', info: args})
    ...
    template: `
      ...
      <button class="h-28 focus:outline-none" v-on:click="$emit('adding-teacher')">
